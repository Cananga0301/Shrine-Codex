...
export default function UploadModal({ onClose, onDone }) {
  ...
  const handleFile = (f) => {
    ...
    if (!f.name.endsWith(".docx")) {
      setError("Chỉ hỗ trợ file .docx trong bản Docker");
      return;
    }
    setFile(f);
  };
  ...
  const handleFolderSelect = (e) => {
    ...
    if (wordFiles.length === 0) {
      setError("Folder không chứa file .docx nào");
      return;
    }
          ...
          >
            ...
            {file ? (
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-gray-400">Kéo thả hoặc nhấn để chọn file .docx</p>
              </div>
            )}
          </div>
        )}
            ...
            {folderFiles.length > 0 ? (
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-gray-300">
                  {folderFiles.length} file .docx được chọn
                </p>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-gray-400">Nhấn để chọn folder chứa file .docx</p>
                <p className="text-xs text-gray-500">Chỉ các file .docx sẽ được xử lý</p>
              </div>
            )}
          </div>
        )}
